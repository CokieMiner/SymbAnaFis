...
use crate::evaluator::logic::instruction::FnOp;
use rustc_hash::FxHashMap;
use std::sync::LazyLock;

pub type ConstFoldFn = fn(f64) -> f64;

pub(super) static FN_MAP: LazyLock<FxHashMap<u64, FnOp>> = LazyLock::new(|| {
...
pub(super) static CONST_FOLD_MAP: LazyLock<FxHashMap<u64, ConstFoldFn>> = LazyLock::new(|| {
    let mut m = FxHashMap::default();
    let ks = &KS;
