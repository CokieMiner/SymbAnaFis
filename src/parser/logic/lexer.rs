...
pub(super) fn get_builtins_set() -> &'static HashSet<&'static str> {
...
pub(super) fn parse_number(s: &str) -> Result<f64, DiffError> {
...
pub(super) fn scan_characters(input: &str) -> Result<Vec<RawToken<'_>>, DiffError> {
