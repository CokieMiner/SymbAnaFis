...
/// Variable for normal PDF
pub const NORMAL_PDF_VAR: &str = "x";
/// Fixed symbols for normal PDF
...
/// Variable for 2D Gaussian
pub const GAUSSIAN_2D_VAR: &str = "x";
/// Fixed symbols for 2D Gaussian
...
/// Variable for Maxwell-Boltzmann
pub const MAXWELL_BOLTZMANN_VAR: &str = "v";
/// Fixed symbols for Maxwell-Boltzmann
...
/// Variable for Lorentz factor
pub const LORENTZ_FACTOR_VAR: &str = "v";
/// Fixed symbols for Lorentz factor
...
/// Variable for damped oscillator
pub const DAMPED_OSCILLATOR_VAR: &str = "t";
/// Fixed symbols for damped oscillator
...
/// Variable for Planck blackbody
pub const PLANCK_BLACKBODY_VAR: &str = "nu";
/// Fixed symbols for Planck blackbody
...
/// Variable for Bessel wave
pub const BESSEL_WAVE_VAR: &str = "r";
/// Fixed symbols for Bessel wave
