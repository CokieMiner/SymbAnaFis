...
def main():
    ...
    try:
        ...
        ani.save('../videos/aizawa_quad.mp4', writer=writer, dpi=100)
        print("✨ Saved ../videos/aizawa_quad.mp4 (GPU)")
    except:
        ani.save('../videos/aizawa_quad.mp4', fps=30, dpi=100)
        print("✨ Saved ../videos/aizawa_quad.mp4 (CPU)")
