...
def main():
    ...
    try:
        ...
        ani.save('../videos/double_pendulum_quad.mp4', writer=writer, dpi=100)
        print("✨ Saved ../videos/double_pendulum_quad.mp4 (GPU)")
    except:
        ani.save('../videos/double_pendulum_quad.mp4', fps=30, dpi=100)
        print("✨ Saved ../videos/double_pendulum_quad.mp4 (CPU)")
